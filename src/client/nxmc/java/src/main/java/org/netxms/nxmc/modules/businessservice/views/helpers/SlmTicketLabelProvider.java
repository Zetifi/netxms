 ...
 */
public class SlmTicketLabelProvider extends LabelProvider implements ITableLabelProvider, ITableColorProvider
{	
   /**
    ...
    */
	...
	{		
	   SlmTicket ticket = (SlmTicket)element;
		switch(columnIndex)
		{
    ...
    */
	...
	{
      SlmTicket check = (SlmTicket)element;
