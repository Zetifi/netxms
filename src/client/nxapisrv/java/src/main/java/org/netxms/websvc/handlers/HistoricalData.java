...
import org.graalvm.compiler.lir.alloc.trace.TraceBuilderPhase_OptionDescriptors;
...
public class HistoricalData extends AbstractObjectHandler {
   ...
   /**
    * Get the instance column values for a given table supports only dci table with
    * a single instance column
    * 
    * @param table
    * @return
    */
   protected ArrayList<String> getTableDciInstances(Table table) throws Exception {
      // raise exception when no instance column is given
